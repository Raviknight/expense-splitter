...
| 18 | **Dashboard layout tweaks** (requested) | "Hi {name}" to the top-left, app name centred in the bar, and the New Group action as a circular floating button bottom-right. |
